...
//   creating your templates. Return an array of template strings. Note: this function
...
const templatingWithMustache = () => characters.map(element => Mustache.render($('#template').html(),element));
